...
// DeactivateTeam provides a mock function with given fields: ctx, teamName
func (_m *TeamService) DeactivateTeam(ctx context.Context, teamName string) (*domains.Team, error) {
